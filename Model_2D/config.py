...
size = int(1e5)  # количество частиц
full_size = int(1e5)  # количество частиц с учетом дублирования частиц
wall_tube = 1
...
max_velocity = 1.5 * 1e7 / 2.5
min_velocity = -1.5 * 1e7 / 2.5

# pre-calculations for check_walls
shape_y_top = shape_y // 2 + height - 0.5
shape_y_bottom = shape_y // 2 - height - 0.5

# pre-calculations for inverse_maxwell_distribution
m_hel = 6.6464764e-27
k = 1.380649e-23
T = 300
k_t_m_hel = (-2 * k * T / m_hel)
denominator = 1e4 / 2.5
